package com.example.lib_common_ui.recyclerview.wrapper;
...
import com.example.lib_common_ui.recyclerview.utils.WrapperUtils;
  ...
  @Override public void onAttachedToRecyclerView(RecyclerView recyclerView) {
    WrapperUtils.onAttachedToRecyclerView(mInnerAdapter, recyclerView,
            new WrapperUtils.SpanSizeCallback() {
              @Override public int getSpanSize(GridLayoutManager gridLayoutManager,
